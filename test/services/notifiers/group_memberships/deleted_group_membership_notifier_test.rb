...
class DeletedGroupMembershipNotifierTest < ActiveSupport::TestCase
  ...
  test "sends email notification" do
    ...
    DeletedGroupMembershipNotifier.call(group_membership)
  ...
  private
    ...
    def email_subject
      "Your #{@group.name} membership was cancelled"
    end
end
